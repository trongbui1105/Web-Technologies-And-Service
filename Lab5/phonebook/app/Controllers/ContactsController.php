...
class ContactsController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($contact->validate($data)) {
            ...
            if ($contact->save()) {
                $add_message = [
                    'add_message' => 'Add Contact Successfully'
                ];
            } else {
                $add_message = [
                    'add_message' => 'Add Contact Failed'
                ];
            }
    ...
    public function update($contactId)
    {
        ...
        if ($contact->validate($data)) {
            if ($contact->fill($data)->save()) {
                $edit_message = [
                    'edit_message' => 'Edit Contact Successfully'
                ];
            } else {
                $edit_message = [
                    'edit_message' => 'Edit Contact Failed'
                ];
            }
    ...
    public function delete($contactId)
    {
        ...
        if ($contact->delete()) {
            $delete_message = [
                'delete_message' => 'Delete Contact Successfully'
            ];
        } else {
            $delete_message = [
                'delete_message' => 'Delete Contact Failed'
            ];
        }
        redirect('/', $delete_message);
    }
}
